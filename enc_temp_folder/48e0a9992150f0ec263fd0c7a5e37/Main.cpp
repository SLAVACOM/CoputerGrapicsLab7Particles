...
void display() {
    ...
    glVertex2f(-0.01f, -0.5f); // Левая нижняя точка
    glVertex2f(0.5f, -0.5f); // Правая нижняя точка
    glVertex2f(0.01f, 0.5f); // Правая верхняя точка
    glVertex2f(-0.5f, 0.5f); // Левая верхняя точка
